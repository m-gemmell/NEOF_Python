...
<center>![](images/matplotlib.webp){}</center>
...
## Import Matplotlib
Add a new line to the <b>top</b> of the Python script containing the work in pandas. We need to import a new library: matplotlib, and specifically the pyplot suite of functions.
...
```
firefox "$PWD"/bmi_groups.png
```

<center>![](images/bar_chart.png){}</center>
...
```
firefox "$PWD"/age_diversity_plot.png
```

<center>![](images/scatter.png){}</center>
