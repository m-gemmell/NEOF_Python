...
There are [supplementary materials](https://neof-workshops.github.io/Python_m4zqwb/Supplemental/) including the use of the Pandas for table based data and Matplotlib for plot production. These can be run through after the course by the learner.
