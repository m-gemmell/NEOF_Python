...
column_1 <- c(
 ...
 '[![](figures/python.png){style="height:150px; border-radius:15px; background:white"}](#intro)',
 ...
 '[![](figures/python_fundamentals.png){style="height:150px; border-radius:15px; background:white; border: 5px solid white"}](#python_fundamentals)',
 '[Data Structures](#data_structures)',
 '[![](figures/python_data_structure.png){style="height:150px; border-radius:15px; background:white"}](#data_structures)',
 '[Conditions (if and else statements)](#python_conditions)',
 '[![](figures/python_condition.png){style="height:150px; border-radius:15px; background:white; border: white solid 5px"}](#python_conditions)',
 ...
 '[![](figures/contract.png){style="height:150px; border-radius:15px; background:white"}](#reading_writing)',
  '[Final exercises](#fundrecapexercise)',
 '[![](figures/exercise_2.png){style="height:150px; border-radius:15px; background:white; border: white solid 5px"}](#fundrecapexercise)'
)
column_2 <- c(
 ...
 '[![](figures/scripting_icon.png){style="height:150px; border-radius:15px; background:white; border: whiet solid 5px"}](#scripting)',
 '[Functions and methods](#functions_methods)',
 '[![](figures/function.png){style="height:150px; border-radius:15px; background:white"}](#functions_methods)',
 '[Fundamental exercise](#fundamental_exercise)',
 '[![](figures/Mimas tiliae.png){style="height:150px; border-radius:15px; background:white"}](#fundamental_exercise)',
 '[Loops](#loops)',
 '[![](figures/loopdeloo.png){style="height:150px; border-radius:15px; background:white; border: white solid 5px"}](#loops)',
 '[Manipulating Sequence Data](#modify_dna_data)',
 '[![](figures/modify_dna.png){style="height:150px; border-radius:15px; background:white; border: white 5px solid"}](#modify_dna_data)',
 '[Logical operators](#logical_operators)',
 '[![](figures/logic.png){style="height:150px; border-radius:15px; background:white; border: white solid 5px"}](#logical_operators)',
   '[Appendix](#further_resources)',
 '[![](figures/further_resources.png){style="height:150px; border-radius:15px; background:white"}](#further_resources)'
)
