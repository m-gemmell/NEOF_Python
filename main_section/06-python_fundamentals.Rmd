...
We are using a __code cell__ per piece of code that gives an output. This is because normally `jupyter-notebook` will only show the last output from a __code cell__.
