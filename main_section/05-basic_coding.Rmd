...
<center>
![](./figures/python_logo.png){style="height:150px; border-radius:5px; border:5px solid white; background:white"}
![](./figures/scripting_icon.png){style="height:150px; border-radius:5px; border:5px solid white; background:white"}
</center>
...
## Issuing commands
<center>
![](./figures/translator.png){style="width:150px; border-radius:5px; border:5px solid white; background:white"}
</center>
...
### Print
<center>
![](figures/printer.png){style="width:100px; border-radius:5px; border:5px solid white; background:white"}
</center>
...
__Note__: Python is very particular about <u id='brackets'>braces/brackets</u>  and <u id='quotes'>quote marks</u>.
...
<center>
![](figures/question_bubble_black.png){style="width:200px; background:white; border-radius:5px; border: 5px solid white"}
</center>
...
```{r, echo=FALSE}
#Tippy tooltips
tippy::tippy_this(elementId = "brackets", 
                  tooltip = "()",
                  arrow = TRUE, placement = "bottom")
tippy::tippy_this(elementId = "quotes", 
                  tooltip = "' or \"",
                  arrow = TRUE, placement = "bottom")
```
