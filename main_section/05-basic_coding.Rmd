...
__MATTHEW CHEK THIS LATTER__  
  
The code editor we are going to be using today attempts to *auto* indent code but we still  need to take care that the level of indentation in the script matches
