...
<center>
![](figures/python_logo.png){style="height:120px; border-radius:15px; border:5px solid white; background:white"} 
![](figures/biopython_logo.png){style="height:120px; border-radius:15px; border:5px solid white; background:white"}
</center>
...
<center>
![](figures/materials.png){style="width:150px; border-radius:15px; border:5px solid white; background:white"}
</center>
...
## Pseudocode
<center>
![](figures/noun-cherry-cake-5973.png){style="width:200px; border-radius:15px; border:5px solid white; background:white"}
</center>
