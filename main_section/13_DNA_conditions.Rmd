# Modifying DNA Data
<center>![](figures/checks.jpeg){height="200px"}![](figures/DNA_icon2.png){height="200px"}</center>
...
knitr::include_graphics(path = "figures/comp_filter.png", auto_pdf = TRUE)
```
...
## Remove PCR primers
<center>![](figures/cut.png){width=20%}![](./figures/DNA_icon.png){}</center>
...
The next bit of coding will retain reads with a GC% between 30% and 70%. This is not normally something you would do but instead we've included it for demonstration purposes.
