...
__Note__: Ensure `wd =` is set to __your__ working directory.
...
We will use `SeqIO's` built in `write()` __method__, specifying we want a FASTQ format file.
...
<center>![](./figures/recap.webp){height=300px}</center>
