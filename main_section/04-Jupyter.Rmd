# Jupyter {#jupyter}
<center>
![](figures/jupyter_logo.png){style="width:200px; background:white; border-radius:5px; border: white 5px solid"}
</center>
...
-   It is lightweight. Other heavier weight programs would struggle in our <u id='hpc'>HPC</u>  due to the graphical and <u id='cpu'>CPU</u> load.
...
`r hide("Moving across cells in jupyter-notebook with the keyboard")`
To use the keyboard to move around and create new cells you will need to know the two different interaction modes.
...
```{r, echo=FALSE}
#Tippy tooltips
tippy::tippy_this(elementId = "hpc", 
                  tooltip = "High Performance Computing",
                  arrow = TRUE, placement = "bottom")
tippy::tippy_this(elementId = "cpu", 
