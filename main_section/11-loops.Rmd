# Loops {#loops}
<center>
![](figures/loopdeloo.png){style="width:200px; background: white; border-radius: 5px; border: white solid 5px"}
</center>
...
<center>
![](figures/loop_thru_dna.png){style="width:200px; background: white; border-radius:5px; border: 5px solid white"}
</center>
...
<center>
![](figures/transcription.png){style="width:200px; background: white; border-radius:5px; border: 5px white solid"}
</center>
...
<center>
![](figures/controller.png){style="width:200px; background: white; border-radius:5px; border: 5px solid white"}
</center>
...
## Loop reflection
<center>
![](figures/reflection.png){style="width:200px; background: white; border-radius:5px; border: 5px solid white"}
</center>
