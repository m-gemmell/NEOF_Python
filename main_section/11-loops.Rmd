...
Create and run the below code in a new _code cell__.
With the code we first create the **dictionary** holding the complementary pairs of bases. 
This needs to come before the for **loop**. 
...
Most likely we won't our output to be have a each base on its own line.
...
Copy your complementation code into a new __code cell__.
...
Ensure you understand while the code is giving you the output.
...
You can control **loops** further using break, continue and pass statements.
We won't cover these in this tutorial as they are much less common. 
You can find good resources covering Python control statements [online](https://www.tutorialspoint.com/python/python_loop_control.htm).
