...
We will explore using loops to move through data more in the next chapter. For now, try out the below `if else statements`.
...
In the below code we create our new variables for the __statement__.
...
nt_count_1 = b.count(nt)
if nt_count_1 == nt_count_1:
